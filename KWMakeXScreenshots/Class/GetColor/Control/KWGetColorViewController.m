//
//  KWGetColorViewController.m
//  KWMakeXScreenshots
//
//  Created by korwin on 2018/2/22.
...
@interface KWGetColorViewController ()<UINavigationControllerDelegate,UIScrollViewDelegate,UIGestureRecognizerDelegate>{
    CGFloat _iXViewH;
    CGFloat _iXViewW;
}
//结构View
...
@implementation KWGetColorViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationItem.title = @"状态栏背景色";
    [self setupIxView];
}
...
- (void)sigleTappedPickerView:(UIGestureRecognizer *)sender {
    ...
    //初始化其属性
    power.iXNavColor = nil;
    
    //传递参数过去
    power.iXNavColor = self.theColor;
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView
{
    ...
    ycenter = scrollView.contentSize.height > scrollView.frame.size.height ? scrollView.contentSize.height/2 : ycenter-20;
