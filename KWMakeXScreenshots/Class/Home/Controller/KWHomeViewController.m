...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithString:@"setting" target:self action:@selector(toSettingVc)];
    self.view.backgroundColor = [UIColor whiteColor];
...
//    self.productView.backgroundColor = [UIColor blueColor];
    ...
    [self makeXScreenshotsWithWeb2:[UIImage imageNamed:@"WEBTAB1"] and:[UIImage imageNamed:@"WEBTAB1"]];
    [self addASaveButton];
}
...
#warning Web已经下拉的
//获取截图
- (void)makeXScreenshotsWithWeb:(UIImage *)screen1 and:(UIImage *)screen2 {
    ...
    CGFloat topInX =  _iXViewH*[self getNumberWithChuShu:48.543479 ByChuShu:812] - [self getNumberWithChuShu:(812*[self getNumberWithChuShu:20 ByChuShu:736]) ByChuShu:812] * _iXViewH + 5;
    self.scrollViewSS1 = [[UIScrollView alloc] initWithFrame:CGRectMake(0, topInX , _iXViewW , SCREENHEIGHT)];
    self.scrollViewSS1.backgroundColor = [UIColor redColor];
...
#warning web_未下拉
- (void)makeXScreenshotsWithWeb2:(UIImage *)screen1 and:(UIImage *)screen2 {
...
#warning 截图1
    ...
    //截取tab位置图片
#warning 计算图片位置
    UIImage *tabNewImage = [UIImage imageFromImage:_imageView.image inRect:CGRectMake(0, _imageView.image.size.height - [self getNumberWithChuShu:40 ByChuShu:736] * _imageView.image.size.height, _imageView.image.size.width, [self getNumberWithChuShu:40 ByChuShu:736] * _imageView.image.size.height)];
    UIImage *tabNewImage2 = [UIImage imageFromImage:tabNewImage inRect:CGRectMake(0, 5, tabNewImage.size.width, tabNewImage.size.height - 5)];
    NSLog(@"_imageView.image.size.height = %lf",_imageView.image.size.height);
    UIColor *tabNewColor = [tabNewImage2 colorAtPixel:CGPointMake(2, 2)];//获取颜色
...
#warning 截图2
    ...
    //tabViewForTab
    self.tabViewForTab = [[UIImageView alloc]initWithFrame:CGRectMake(0, tabImageTop + 5, _iXViewW, 40)];
    self.tabViewForTab.image = tabNewImage2;
    [self.navigationView addSubview:_tabViewForTab];
...
- (void)addASaveButton {
    ...
    UIImage *staImage = [UIImage imageNamed:@"staButton"];
    self.staButton = [[UIButton alloc]init];
    self.staButton = [UIButton buttonWithImage:[UIImage imageNamed:@"staButton"] hightImage:[UIImage imageNamed:@"staButton_click"] target:self action:@selector(selectStaColor)];
    ...
    self.tabButton = [UIButton buttonWithImage:[UIImage imageNamed:@"staButton"] hightImage:[UIImage imageNamed:@"staButton_click"] target:self action:@selector(selectTabColor)];
